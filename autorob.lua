...
-- Feste Werte für Health und Polizei
...
local WebhookGroup = Window:MakeTabGroup({ Name = "Webhook" })  -- NEU
...
local tabs = {
    ...
    Webhook = WebhookGroup:MakeTab({ Name = "Webhook",  Icon = "rbxassetid://4483345998" }),  -- NEU
}
...
-- Slider für Player Speed, Low Health, Police Range entfernt (fest)
tabs.AutoRob:AddSlider({
...
-- ===== Restlicher Script-Code (unverändert) =====
